      ...
      <section className="relative flex h-[600px] flex-col items-center justify-center overflow-hidden px-6 text-center md:h-[700px] md:px-12">
        ...
        <div className="relative z-10 max-w-4xl pt-20">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link href="/mi?tab=dictionary" className="inline-flex items-center justify-center rounded-full bg-[#B24A2D] px-8 py-6 text-[15px] font-semibold text-white transition-colors hover:bg-[#8A3620]">
              Explore Archives
            </Link>
